...
<body>
        ...
        <header class="main-header header-style-two">
            ...
            <div class="header-lower">
                <div class="auto-container">
                    <div class="outer-box">
                        <figure class="logo-box"><a href="{{url('/')}}"><img style="height:100px;" src="{{asset('uploads/blueheightslogo.png')}}" alt=""></a></figure>
                        <div class="menu-area">
            ...
            <div class="sticky-header">
                <div class="auto-container">
                    <div class="outer-box">
                        <div class="logo-box">
                            <figure class="logo"><a href="{{url('/')}}"><img style="height:100px" src="{{asset('uploads/blueheightslogo.png')}}" alt=""></a></figure>
                        </div>
                        <div class="menu-area">
            ...
            <nav class="menu-box">
                ...
                <div class="contact-info">
                    ...
                    <ul>
                        ...
                        <li><a href="tel:+254720230250">(+254) 720 230 250</a></li>
                        <li><a href="mailto:marketing@blueheightsltd.com">marketing@blueheightsltd.com</a></li>
                    </ul>
                </div>
                ...
                <div class="slide-item p_relative">
                    <div class="bg-layers">
                        <video autoplay muted loop id="myVideo">
                           <source src="{{asset('uploads/7648408-hd_1280_720_30fps.mp4')}}" type="video/mp4">
                        </video>
                    </div>
                    ...
                    <div class="auto-container">
                        <div class="content-box">
                            ...
                            <br><br>
                            <a href="#about" class="theme-btn btn-one">Learn More</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="auto-container">
            <div class="row align-items-center">
                ...
                <div class="col-lg-6 col-md-12 col-sm-12 image-column">
                    <div class="image-box">
                        <figure class="image image-1"><img src="{{asset('theme/assets/images/about.jpeg')}}" alt=""></figure>
                    </div>
                </div>
            </div>
        </div>
    ...
    <!-- gallery-section end -->
        ...
        <section class="conference-style-two pt_60 pb_60" id="more-our-services">
            ...
            <div class="auto-container" >
                <center>
                    <div class="row clearfix" style="margin:5px">
                        ...
                        <div class="col-lg-2 col-md-6 col-sm-12 client-logo">
                            <img class="client-logo-img" src="{{asset('theme/assets/images/159-1590925_siemens-logo-png-transparent-png-removebg-preview.png')}}" alt="">
                        </div>
                        <div class="col-lg-3 col-md-6 col-sm-12 client-logo">
                            <img class="client-logo-img" src="{{asset('theme/assets/images/prdlogo.png')}}" alt="">
                        </div>
                        <div class="col-lg-2 col-md-6 col-sm-12 client-logo">
                            <img class="client-logo-img" src="{{asset('theme/assets/images/11-GAK-Logo.png')}}" alt="">
                        </div>
                        <div class="col-lg-2 col-md-6 col-sm-12 client-logo">
                            <img class="client-logo-img" src="{{asset('theme/assets/images/STRYDE-Logo-Firesm.png')}}" alt="">
                        </div>
                        <div class="col-lg-2 col-md-6 col-sm-12 client-logo">
